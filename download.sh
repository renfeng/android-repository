...
cat sdk/template.html | sed '/<!-- insert -->/q' | tee sdk/index.html
cat orig/sdk/index.html | \
    ...
    tee -a sdk/index.html
cat sdk/template.html | sed -n '/<!-- insert -->/,$p' | tee -a sdk/index.html
...
grep true packages.csv | grep -Po '(?<=https://dl-ssl[.]google[.]com/)[^,]+|(?<=https://dl[.]google[.]com/)[^,]+' | sed -r 's/^(.*)$/rm -f \1/g' | tee clean-obsolete.sh
